<div class="sidebar h-sidebar navbar-collapse collapse ace-save-state sidebar-fixed" id="sidebar" data-sidebar="true" data-sidebar-scroll="true" data-sidebar-hover="true" style="margin-top: 17px;">
            ...
            <div class="nav-wrap-up pos-rel"><div class="nav-wrap"><div style="position: relative; top: 0px; transition-property: top; transition-duration: 0.15s;"><div id="sidebar-shortcuts" class="sidebar-shortcuts">
                ...
                <li class="hover">
                    <a href="<?php echo base_url('sinhvien/home/index'); ?>">
                ...
                <li class="hover">
                    ...
                    <ul class="submenu can-scroll ace-scroll scroll-disabled" style="">
                        <li class="hover">
                            <a href="<?php echo base_url('sinhvien/tkb_ci/xemtkb'); ?>">
                        ...
                        <li class="hover">
                            <a href="<?php echo base_url('sinhvien/lichthi_ci/xemlichthi') ?>">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Lịch Thi Học Kì
                            </a>
                            <b class="arrow"></b>
                ...
                <li class="">
                    <a class="" href="<?php echo base_url('sinhvien/hoc_phi/xemhp'); ?>">
                ...
                <li class="hover">
                    ...
                    <ul class="submenu can-scroll ace-scroll scroll-disabled" style="">
                        <li class="hover">
                            <a href="<?php echo base_url('sinhvien/diemrenluyen/xemdrl'); ?>">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Điểm Rèn Luyện
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="<?php echo base_url('sinhvien/kqht_ci/xemkqht'); ?>">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Kết Qủa Học Tập
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="<?php echo base_url('sinhvien/ctdt_ci/xemctdt'); ?>">
                                <i class="menu-icon fa fa-caret-right"></i>
