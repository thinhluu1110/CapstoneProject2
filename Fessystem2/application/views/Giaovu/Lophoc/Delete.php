...
<div style="width:100%">
  <div class="col-xs-12">
              <div class="modal-content">
                <form id="frmEditEmployee" name="frmCreateEmployee" method="post" action="<?php echo base_url('Giaovu/Lophoc/Del/'.$lophoc_info['lophoc_id']) ?>" class="form-horizontal" role="form" ng-submit="UpdateEmployee()">
