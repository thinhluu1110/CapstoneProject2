...
<div class="row">
    <div class="col-xs-12">
        <div id="dialogValidation_Thietlaptrangthai_SV" data-backdrop = "static" data-keyboard = "false" class="modal fade" tabindex="-1" style="padding-top: 0px; padding-bottom: 0px; padding-left: 17px;" aria-hidden="false">
            <div class="modal-dialog" style="width:400px !important;height:600px !important">
              ...
              <div class="modal-footer" style="padding:0px;">
                <input type="button" style="width: 100%;" class="btn btn-sm btn-success" id="submit_delnganh" name="Xóa" onclick="window.location = '<?php echo base_url('Giaovu/Sinhvien/index')?>'" value="OK">
            </div>
        </form>
                </div>
            </div>
