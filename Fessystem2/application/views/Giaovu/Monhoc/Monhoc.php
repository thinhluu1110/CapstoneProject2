                            ...
                            <div class="row" style="margin:10px">
                                ...
                                <div hidden class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="" id="mamon_edit" name="mamon_edit" disabled />
                                    </div>
                                    <div class="form-group">
...
<div class="row">
    <div class="col-xs-12">
        <div id="dialogValidation_Add_Mon" data-backdrop = "static" data-keyboard = "false" class="modal fade" tabindex="-1" style="padding-top: 0px; padding-bottom: 0px; padding-left: 17px;" aria-hidden="false">
            <div class="modal-dialog" style="width:400px !important;height:600px !important">
                <div class="modal-content">
