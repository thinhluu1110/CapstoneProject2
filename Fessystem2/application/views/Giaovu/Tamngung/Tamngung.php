                    ...
                    <tbody>
                      <?php for ($i=0; $i <count($svStatus) ; $i++) { ?>
                        <tr style="cursor:pointer">
                            ...
                            <td class="text-center">
                                <?php echo $svStatus[$i]['ngay_ketthuc']?>
                            </td>
                            <td>
                            ...
                            <?php if ($this->session->userdata('phanquyen') == 1) { ?>
                            <td class="text-center">
                                <!-- <a href="<?php echo base_url('Giaovu/Sinhvien/delstatusTN/').$svStatus[$i]['MSSV'] ?>" class="btn-sm btn-danger" title="Xóa"><i class="fa fa-remove"></i></a> -->
