    ...
    <div class="hitec-content">
              ...
              <div class="col-xs-3">
                  <div class="input-group hitec-w-100percent">
                    <select class="form-control" id="TimeTN" name="TimeTN" onchange='if(this.value != 0) { this.form.submit(); }'>
                      ...
                      <option value="9to6" <?php if ($this->input->get('TimeTN') == '9to6') {echo "selected";} ?> >--- 9 Tháng Đến 6 Tháng ---</option>
                      <option value="6to3" <?php if ($this->input->get('TimeTN') == '6to3') {echo "selected";} ?> >--- 6 Tháng Đến 3 Tháng ---</option>
                      <option value="3to1" <?php if ($this->input->get('TimeTN') == '3to1') {echo "selected";} ?> >--- 3 Tháng Đến 1 Tháng ---</option>
                      <option value="1" <?php if ($this->input->get('TimeTN') == '1') {echo "selected";} ?> >--- 1 Tháng ---</option>
                    </select>
                  </div>
              </div>
                <div class="col-xs-4">
        ...
        <div id="searchResult" style="margin-top:5px;">
          ...
          <div class="container-fluid text-right">
                <a href="<?php if($svStatus != null){echo base_url('Giaovu/Tamngung/index?exp=exp&TimeTN=').$this->input->get('TimeTN');}?> "><u>[Xuất Danh Sách Ra Excel]</u>
                </a>
            </div>
            <?php } ?>
            <div class="container-fluid">
                      ...
                      <?php for ($i=0; $i <count($svStatus) ; $i++) { ?>
                        <tr style=" <?php if($svStatus[$i]['Alert'] <= 30){echo "color:red;";} ?> cursor:pointer">
                          ...
                          <td>
                            ...
                            <?php if ($this->session->userdata('phanquyen') == 1) { ?>
                            <td class="text-center">
                                <a class="btn-sm btn-danger delete_TamNgung" id ="<?php echo $svStatus[$i]['MSSV'] ?>" title="Xóa" data-toggle="modal" data-target="#dialogDelete">
            ...
            <div class="modal-dialog" style="width:400px !important;height:600px !important">
                <div class="modal-content">
                    ...
                    <form id="frmEditEmployee" name="frmCreateEmployee" method="post" class="form-horizontal" role="form" ng-submit="UpdateEmployee()">
                        ...
                        <div hidden="hidden" id="msg-success-delete-TN" class="modal-header add_success" style="padding:0px;text-align:center">
                        ...
                        <div class="modal-footer" style="padding:0px">
                            <input type="button" class="btn btn-sm btn-danger" id="submit_delete_tamngung" name="Xóa" value="Xóa">
                        </div>
                    </form>
