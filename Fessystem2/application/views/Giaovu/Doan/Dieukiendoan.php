                               ...
                               for ($i=0; $i < count($listDKDA); $i++) { ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="padding: 8px 0">
                                      ...
                                      <a class="btn-sm btn-danger delete_dkda" id="<?php echo $listDKDA[$i]['dkda_id'] ?>" data-toggle="modal" data-target="#dialogDelete_DKDA" style="margin-right: 4px;">
...
<div id="dialogEditDKDA" class="modal fade" tabindex="-1" style="padding-top: 0px; padding-bottom: 0px; padding-left: 17px;" aria-hidden="false">
    <div class="modal-dialog" style="width:400px !important;height:600px !important">
        <div class="modal-content">
            <form id="form_dieukien_doan_edit" name="frmCreateEmployee" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                <div class="modal-header bg-primary" style="padding:0px;text-align:center">
                    <button onclick="reload()" type="button" class="close" data-dismiss="modal">×</button>
                    ...
                    <div class="row" style="margin:10px">
                        <div class="col-xs-12 col-md-12 col-lg-12">
                          <div hidden="" class="form-group">
                              <input class="form-control" id="dieukien_doan_edit_id" name="id_dkda" />
                          </div>
                          <div class="form-group">
                              <label class="coltrol-lable">Áp Dụng Cho Ngành:</label>
                              <input class="form-control" id="nganhhoc_dieukien_doan_edit" name="nganhhoc" disabled />
                          </div>
                          <div class="form-group">
                              <label class="coltrol-lable">Áp Dụng Cho Khóa:</label>
                              <input class="form-control" id="khoahoc_dieukien_doan_edit" name="khoahoc" disabled />
                          </div>
                            <div class="form-group">
                                <label class="coltrol-lable">Số Môn Được Nợ Tối Đa:</label>
                            ...
                            <div class="form-group">
                                <label class="coltrol-lable">Môn Không Được Phép Nợ:</label>
                                <select class="form-control" id="monkoduocno_dieukien_doan_edit" name="monkoduocno" >
                                <option value="">--- Chọn Môn ---</option>

                                </select>
                            </div>
                            <div class="form-group">
                            <ul id="review_select_edit" style="margin: 5px 0 0 0; list-style: none">
                            </ul>
                          </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-xs-12">
        <div id="dialogDelete_DKDA" data-backdrop = "static" data-keyboard = "false" class="modal fade" tabindex="-1" style="padding-top: 0px; padding-bottom: 0px; padding-left: 17px;" aria-hidden="false">
            <div class="modal-dialog" style="width:400px !important;height:600px !important">
                <div class="modal-content">
                <form id="form-delete-dkda" name="frmCreateEmployee" method="post"  class="form-horizontal" role="form" ng-submit="UpdateEmployee()">
                    <div class="modal-header bg-primary" style="padding:0px;text-align:center">
                        <button onclick="reload()" type="button" class="close" data-dismiss="modal">×</button>
                        <h5><strong class="modal-title">Xóa Điều Kiện Đồ Án</strong></h5>
                        </div>
                        <div hidden="hidden" id="msg-success-delete-dkda" class="modal-header add_success" style="padding:0px;text-align:center">
                            <h5><strong class="modal-title"></strong></h5>
                        </div>
                        <div hidden="hidden" id="msg-fail-delete-dkda" class="modal-header add_fail" style="padding:0px;text-align:center">
                            <h5><strong class="modal-title"></strong></h5>
                        </div>
                    <!-- <div hidden class="form-group">
...
<div class="row">
    <div class="col-xs-12">
        <div id="dialogValidation_Add_DKDA" data-backdrop = "static" data-keyboard = "false" class="modal fade" tabindex="-1" style="padding-top: 0px; padding-bottom: 0px; padding-left: 17px;" aria-hidden="false">
            <div class="modal-dialog" style="width:400px !important;height:600px !important">
                <div class="modal-content">
